...
def get_all_orders():
    orders = list(orderCollection.find({}, {"_id": 0, "itemID": 1, "itemStatus": 1, "quantity": 1, "itemName": 1, "category": 1, "totalPrice": 1, "orderID": 1}))
    return orders

#Return orders held by specific customer
def get_customer_orders(username): 
    orders = list(orderCollection.find({"username":username}, {"_id": 0, "itemID": 1, "itemStatus": 1,"quantity": 1, "itemName": 1, "category": 1, "totalPrice": 1, "orderID": 1}))
    return orders